...
import { getAttributesForEntityType } from './getAttributesForEntityType'

describe('getAttributesForEntityType', () => {
  describe('when entity type is "user"', () => {
    it('should return all user attributes', () => {
      const attributes = getAttributesForEntityType('user')
  ...
  describe('when entity type is "site"', () => {
    it('should return all site attributes', () => {
      const attributes = getAttributesForEntityType('site')
  ...
  it('should return an array of AlobeesAttribute objects with correct structure', () => {
    const userAttributes = getAttributesForEntityType('user')
    const siteAttributes = getAttributesForEntityType('site')
